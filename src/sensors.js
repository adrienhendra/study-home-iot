...
class BaseSensor {
    ...
    createFacade(facePictureName = 'activity.png') {
        // /* Create object facade */
        // this.sprites = new Object();
        if (undefined !== typeof this.controlObjects && null != this.controlObjects) {
            ...
            Object.keys(this.controlObjects).forEach(k => {
                Console.log(
                    `Added sensor object ${this.controlObjects[k].name} with initial value of ${
                ...
                remote_sprite = new PxSprite(this.textureRef[facePictureName]);
    ...
    updateControl(channel, value, sendSignal) {
        ...
        if (undefined !== typeof temp_val && null != temp_val) {
            /* Channel available */
            Console.log(
                `[SENSOR] Name: ${this.name} ${this.controlObjects[channel].name}, Ch: ${channel}, Val: ${value}`
            );
...
class TemperatureSensor extends BaseSensor {
    constructor(name, x, y, pixiAppRef, ctrlObj = null) {
        ...
        /* Create object facade */
        this.createFacade('temperature.png');
    }
}
...
class HumiditySensor extends BaseSensor {
    constructor(name, x, y, pixiAppRef, ctrlObj = null) {
        ...
        /* Create object facade */
        this.createFacade('hygro.png');
    }
}

class BarometerSensor extends BaseSensor {
    constructor(name, x, y, pixiAppRef, ctrlObj = null) {
        super();
        this.name = name;
        this.controlObjects = ctrlObj;
        ...
        /* Create object facade */
        this.createFacade('atm-pressure.png');
    }
}
...
class MotionSensor extends BaseSensor {
    constructor(name, x, y, pixiAppRef, ctrlObj = null) {
        ...
        /* Create object facade */
        this.createFacade('motion-detect.png');
    }
}
...
class SoundSensor extends BaseSensor {
    constructor(name, x, y, pixiAppRef, ctrlObj = null) {
        ...
        /* Create object facade */
        this.createFacade('activity.png');
    }
}

class PresenceSensor extends BaseSensor {
    constructor(name, x, y, pixiAppRef, ctrlObj = null) {
        super();
        this.name = name;
        this.controlObjects = ctrlObj;
        ...
        /* Create object facade */
        this.createFacade('motion-sensor.png');
    }
}
